...
class TestSemanticSimilarity:
    ...
    def test_similarity_between_unrelated_resume_and_jd(self):
        ...
        assert 0.0 <= score <= 1.0
        # A backend resume vs a design JD should score lower than a direct match
        matching_score = semantic_similarity("sim-resume-match", "sim-jd-match") \
            if False else None  # placeholder to avoid cross-test dependency
